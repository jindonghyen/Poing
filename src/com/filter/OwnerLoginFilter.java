...
public class OwnerLoginFilter implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
		System.out.println("OwnerLoginFilter doFilter");
		...
		if (session == null || session.getAttribute("authOwner") == null) {
			session.setAttribute("nextLink", filterRequest.getRequestURI());
			filterResponse.sendRedirect(filterRequest.getContextPath() + "/owner/login.ow");
